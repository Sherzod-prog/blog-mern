...
const PostPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
      {post && (
        <div className="my-4">
          <h1 className="text-xl font-semibold uppercase text-center py-2">
            {post.title}
          </h1>
          <div>
            <Image
          ...
          <div className="pl-3 border-t-2 font-medium text-lg pb-1 pt-3">
            Comments ...
          </div>
          <div className="pl-3">
            {comments &&
              comments
                .map((com) => (
                  <div
                    key={com._id}
                    className="my-1 odd:bg-secondary py-3 px-2 rounded-sm"
                  >
                    <div className="flex justify-start items-center gap-2 font-medium my-1">
                      <Avatar>
                        <AvatarImage
                          src={com.user?.avatar}
                          alt={com.user?.name}
                      ...
                      <div className="font-semibolds">{com.user?.name}</div>
                    </div>
